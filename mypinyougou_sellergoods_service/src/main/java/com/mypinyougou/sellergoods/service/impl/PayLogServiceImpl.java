...
import com.mypinyougou.mapper.TbPayLogMapper;
import com.mypinyougou.pojo.TbPayLog;
import com.mypinyougou.pojo.TbPayLogExample;
import com.mypinyougou.sellergoods.service.PayLogService;
...
public class PayLogServiceImpl implements PayLogService {
	...
	public TbPayLog findOne(Long id){
		return payLogMapper.selectByPrimaryKey(id);//代码生成的对应接口中id原本为String类型
	}
	...
	public void delete(Long[] ids) {
		for(Long id:ids){
			payLogMapper.deleteByPrimaryKey(id);//代码生成的对应接口中id原本为String类型
		}		
	}
