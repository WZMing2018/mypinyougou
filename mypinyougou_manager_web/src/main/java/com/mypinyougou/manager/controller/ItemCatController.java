...
import com.mypinyougou.pojo.TbItemCat;
import com.mypinyougou.sellergoods.service.ItemCatService;
...
public class ItemCatController {
	...
	@RequestMapping("/findItemByParentId/{parentId}")
	public List<TbItemCat> findItemByParentId(@PathVariable("parentId") Long parentId) {
		return itemCatService.findItemByParentId(parentId);
