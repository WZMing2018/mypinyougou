...
public class SpecificationController {
    ...
    @RequestMapping("/findSpecAndOption/{typeId}")
    public List<Map> findSpecAndOption(@PathVariable("typeId") Long typeId) {
        return tbSpecificationService.findSpecAndOption(typeId);
    }
